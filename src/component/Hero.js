      ...
      <div className="bg-[#ffffec] h-screen">
        <nav className="flex justify-around py-5 ">
          <div className=" w-3/12">
            <h1 className="font-luckiest text-3xl text-[#597E52]">CYkir SHOP</h1>
          </div>
          <div className="w-6/12 align-content-center ">
            <ul className="flex justify-center">
              <li className="w-4/12 text-center font-mochiy text-xl text-[#597E52] cursor-pointer hover:text-[#4a963b]">
                Home
              </li>
              <li className="w-4/12 text-center font-mochiy text-xl text-[#597E52] cursor-pointer hover:text-[#4a963b]">
                Service
        ...
        <div className="flex justify-around">
          <di className="w-4/12 my-20">
            ...
            <button
              ...
              className="rounded-full bg-[#C6A969] text-white px-5 py-3 w-36 hover:bg-[#d6ab4e] hover:font-bold"
            >
              Read More
            </button>
          </di>
